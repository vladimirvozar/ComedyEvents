...
namespace ComedyEvents.Services
{
    public class EventRepository : IEventRepository
    {
        ...
        public async Task<Comedian> GetComedian(int comedianId)
        {
            ...
            var query = _eventContext.Comedians.Where(c => c.ComedianId == comedianId);
        ...
        public async Task<Comedian[]> GetComedians()
        {
            ...
            var query = _eventContext.Comedians.OrderBy(c => c.LastName);
        ...
        {
            _logger.LogInformation($"Getting comedians for event with id {eventId}");
        ...
        public async Task<Event[]> GetEventsByDate(DateTime date, bool includeGigs = false)
        {
            ...
            query = query.OrderBy(e => e.EventDate).Where(e => e.EventDate == date);
        ...
        {
            _logger.LogInformation($"Getting a gig for id {gigId}");
